  ...
  while (SCRIPTS[executionPointer] != -2000) {
    ...
    if (ifNested) {
      ...
      while (SCRIPTS[++executionPointer] != -1000) {
	    ...
	    SCRIPTS[executionPointer] != QMOUSEOVER &&
            ...
            SCRIPTS[executionPointer] != INP_MOUSE_X &&
            SCRIPTS[executionPointer] != INP_MOUSE_Y &&	    
            SCRIPTS[executionPointer] != INP_MOUSE_LEFT &&
            SCRIPTS[executionPointer] != INP_MOUSE_RIGHT &&
            SCRIPTS[executionPointer] != INP_CLICK_LEFT &&
            SCRIPTS[executionPointer] != INP_CLICK_RIGHT
	    )
          executionPointer++;
      }
      executionPointer++;
    ...
    while (SCRIPTS[executionPointer] != -1000) {
      ...
      case QMOUSEOVER: {
	BUFFER[bufferPointer++] = INT;
	BUFFER[bufferPointer++] = MOUSE_X >= self->ECB.x && MOUSE_X < self->ECB.x + self->ECB.w && MOUSE_Y >= self->ECB.y && MOUSE_Y < self->ECB.y + self->ECB.h;
       break;
      }
      case QSONG: {
        BUFFER[bufferPointer++] = STRING;
      ...
      case INP_MOUSE_X: {
      	BUFFER[bufferPointer++] = INT;
	BUFFER[bufferPointer++] = MOUSE_X;
     	break; 
      }
      case INP_MOUSE_Y: {
       	BUFFER[bufferPointer++] = INT;
	BUFFER[bufferPointer++] = MOUSE_Y;
      	break;
      }
      case INP_MOUSE_LEFT: {
       	BUFFER[bufferPointer++] = INT;
	BUFFER[bufferPointer++] = MOUSE_LEFT;
      	break;
      }
      case INP_MOUSE_RIGHT: {
       	BUFFER[bufferPointer++] = INT;
	BUFFER[bufferPointer++] = MOUSE_RIGHT;
      	break;
      }
      case INP_CLICK_LEFT: {
       	BUFFER[bufferPointer++] = INT;
	BUFFER[bufferPointer++] = CLICK_LEFT;
      	break;
      }
      case INP_CLICK_RIGHT: {
       	BUFFER[bufferPointer++] = INT;
	BUFFER[bufferPointer++] = CLICK_RIGHT;
      	break;
      }
      case INP_A: {
